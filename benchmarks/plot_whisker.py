...
Source: https://raw.githubusercontent.com/sharkdp/hyperfine/49fcc4be37f1e02ff4e5b24cae34e2e0aaae89f4/scripts/plot_whisker.py
"""
...
if args.labels:
    ...
    labels = [ str(i + 1) + " " + b["command"] for (i,b) in enumerate(results)]
